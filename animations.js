...
function setupParticleWaveCanvas() {
  ...
  // Squeezed multi-tier radius metrics (Optimized size to prevent edge clipping at canvas boundaries)
...
function selectPlan(plan) {
  const control = document.querySelector('.ios-segmented-control');
  if (control) {
    control.setAttribute('data-active', plan);
  }
